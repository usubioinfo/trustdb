...
<html>
    <head>
        ...
        <meta name="description" content="Puccinia species effector proteins.">
        ...
        <!-- App title -->
        <title>Effector Proteins - TRustDB</title>
...
<!-- End Navigation Bar-->
        ...
        <div class="wrapper">
            <div class="container">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>
                                    This module contains the proteins of <i>Pgt</i> Ug99 and <i>Pgt</i> 21-0 that serve as Effector proteins.
                                </p>                                
                ...
                <div class="row">
                    <div class="col-xl-8">
                        <h4 class="page-title"><i>Puccinia</i> Effector Proteins <i class="zmdi zmdi-info-outline" style="font-size: 25px" data-toggle="modal" data-target="#modal"></i></h4>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            ...
            request.open("POST", "https://bioinfo.usu.edu/trustdb/queryEffProtein.php",true);
                ...
                if (request.readyState === request.DONE) {
                    if (request.status === 200) {
                        ...
                        for(i = 0; i< lines.length-1; i++){
                            ...
                            tableString  = tableString + '<td><a href="https://effectorp.csiro.au/"> EffectorP </a>'+'</td>';
                            // tableString  = tableString + '<td>'+"EffectorP"+'</td>';
                            tableString  = tableString + '</tr>';
                        }
