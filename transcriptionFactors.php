...
<!-- End Navigation Bar-->
        ...
        <div class="wrapper">
            <div class="container">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>This module contains information about the <i>Triticum</i> proteins that serve as transcription factors.  </p>
                                <hr>
                                <p><i>Triticum</i> proteins were predicted as transcription factors using an online tool, available at <a href="https://planttfdb.gao-lab.org/prediction.php" target="_blank" "> PlantTFDB </a>.</p>
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-8">
                        <h4 class="page-title"> <i>Triticum aestivum</i> Transcription Factors <i class="zmdi zmdi-info-outline" style="font-size: 25px" data-toggle="modal" data-target="#modal"></i></h4>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-5" id="speciesSelect" >
                                <select class="form-control select2" id="triticumI" style="font-style: italic;">
                                    <optgroup label="Triticum species" style="font-style: italic;">
        ...
        $("#buttonSearch").click(function() {
            ...
            request.open("POST", "https://bioinfo.usu.edu/trustdb/queryWheatTF.php",true);
