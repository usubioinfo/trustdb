...
<html>
    <head>
        ...
        <meta name="description" content="Puccinia species Effector and Secretory proteins.">
...
<!-- End Navigation Bar-->
        ...
        <div class="wrapper">
            <div class="container">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>
                                    This module contain the <i>Puccinia</i> proteins that serve both as 'effector' and 'secretory' proteins.
                                </p>
                                <!-- <hr>
                                <p>
                                    The proteins of <i>Pgt</i> Ug99 and <i>Pgt</i> 21-0 were predicted as effector and secretory proteins using <a href="https://effectorp.csiro.au/" target="_blank"">EffectorP 2.0</a> and <a href="https://www.cbs.dtu.dk/services/SignalP/" target="_blank"">SignalP-5.0</a>, respectively. After this, the proteins that were found to be both effector and secretory were extracted.
                                </p> -->
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-8">
                        <h4 class="page-title">Effector and Secretory Proteins <i class="zmdi zmdi-info-outline" style="font-size: 25px" data-toggle="modal" data-target="#modal"></i></h4>
                    </div>
                </div>
                    ...
                    <div class="card-box">
                        ...
                        <table id="tableEffectors" class="table"  cellspacing="0" width="100%" style="font-size: 14px">
                            <thead class='thead-dark'>
                                <tr role="row">
                                    <th>Identifier</th>
                                    <!-- <th style="width: 248px;">Alternative ID</th> -->
                                    <th>Description</th>
                                    <th>Protein Length</th>
                                    <th style="width: 140px;">Prediction Tools</th>
                                </tr>
                            </thead>
                            <tbody id="bodyTable">
        ...
        <script type="text/javascript">
            ...
            request.open("POST", "https://bioinfo.usu.edu/trustdb/queryEffectors.php",true);
                ...
                if (request.readyState === request.DONE) {
                    if (request.status === 200) {
                        ...
                        for(i = 0; i< lines.length-1; i++){
                            ...
                            tableString  = tableString + '<td>'+"EffectorP & SignalP"+'</td>';
                            tableString  = tableString + '</tr>';
                        }
