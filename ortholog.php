...
<html>
    <head>
        ...
        <meta name="description" content="Puccinia protein orthologs">
        ...
        <!-- App title -->
        <title>Puccinia Orthologs - TRustDB</title>
...
<!-- End Navigation Bar-->
        ...
        <div class="wrapper">
            <div class="container">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>The protein orthologs for <i>Pgt</i> Ug99 and <i>Pgt</i> 21-0 used in this module were predicted using the tool <a href="https://github.com/davidemms/OrthoFinder" target="_blank" style="color:green;">OrthoFinder</a>. The sequences of the respective <i>Puccinia</i> orthologs can be downloaded using the Ortho Group ID.</p>
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <h4 class="page-title"> <i>Puccinia</i> Protein Orthologs <i class="zmdi zmdi-info-outline" style="font-size: 25px" data-toggle="modal" data-target="#modal"></i></h4>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card-box">
                        <div class="row">
                            <div class="col-md-5" id="speciesSelect" >
                                <select class="form-control select2" id="pucciniaI" style="font-style: italic;">
                                    <optgroup label="Puccinia [Infecting Triticum]" style="font-style: italic;">
                                        <option value="pug99">Puccinia orthologs</option>
                                    </optgroup>
                                </select>
                            </div>
                        ...
                        <table id="tableDescription" class="table"  cellspacing="0" width="100%" style="font-size: 14px">
                            <thead class='thead-dark'>
                                <tr role="row">
                                    <th>Ortho Group</th>
                                    <th><i>Puccinia graminis</i> 21-0 protein</th>
                                    <th><i>Puccinia graminis</i> Ug99 protein</th>
                                </tr>
                            </thead>
                            <tbody id="bodyTable">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                //Buttons examples
                var table = $('#tableDescription').DataTable({});
            ...
            request.open("POST", "https://bioinfo.usu.edu/trustdb/queryPucciniaOrtho.php",true);
                ...
                if (request.readyState === request.DONE) {
                    if (request.status === 200) {
                        ...
                        for(i = 0; i< lines.length-1; i++){
                            ...
                            tableString  = tableString + '<td><a href="orthologs/' + record[0] + '.fa' + '" target="_blank">'+ record[0] +'</a></td>';
                            // tableString  = tableString + '<td>'+record[0]+'</td>';
                            tableString  = tableString + '<td>'+record[1]+'</td>';
                            tableString  = tableString + '<td>'+record[2]+'</td>';
                            tableString  = tableString + '</tr>';
                        }

                        $('#tableDescription').DataTable().clear();
                        $('#tableDescription').DataTable().destroy();

                        document.getElementById('bodyTable').innerHTML = tableString;

                        $('#tableDescription').DataTable({"pageLength": 25});
