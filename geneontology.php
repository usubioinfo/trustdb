...
<html>
    <head>
        ...
        <meta name="description" content="Gene Ontology for Puccinia graminis species proteins">
...
<!-- End Navigation Bar-->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>This is a list of <i>Puccinia</i> proteins GO annotations obtained using the InterProScan software. For some of the accesions, no GO annotation was retrieved, still, we provide those records in order to let the users decide which information they want to use.</p>
                            </div>
        ...
        <script type="text/javascript">
            ...
            request.open("POST", "http://127.0.1.1:80/trustdb/queryPathogenGO.php",true);
