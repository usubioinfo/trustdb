...
<html>
    <head>
        ...
        <meta name="description" content="Subcellular localizations of Triticum aestivum proteins.">
    ...
    <!-- End Navigation Bar-->
        ...
        <div class="wrapper">
            <div class="container">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>
                                    This module comprises of protein subcellular localization annotations of the <i>Triticum aestivum</i> proteins, predicted using the tool: <a target="_blank" href="http://127.0.1.1:80/Plant-mSubP/">Plant-mSubP</a>.
                                </p>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <h4 class="page-title"> Subcellular Localization Annotations <i class="zmdi zmdi-info-outline" style="font-size: 25px" data-toggle="modal" data-target="#modal"></i></h4>
                    </div>
                </div>
                    ...
                    <div class="card-box">
                        <div class="row">
                            <div class="col-md-5" id="speciesSelect" >
                                <select class="form-control select2" id="triticum" style="font-style: italic;">
                        ...
                        <table id="tableEffectors" class="table table-striped table-bordered"  cellspacing="0" width="100%"class="table"  cellspacing="0" width="100%" style="font-size: 14px">
                            <thead class='thead-dark'>
                                <tr role="row">
                                    ...
                                    <th style="width: 200px">Subcellular Localization</th>
                                </tr>
                            </thead>
                            <tbody id="bodyTable">
        ...
        <script type="text/javascript">
            ...
            request.open("POST", "http://127.0.1.1:80/trustdb/queryHostLoc.php",true);
                ...
                if (request.readyState === request.DONE) {
                    if (request.status === 200) {
                        ...
                        for(i = 0; i< lines.length-1; i++){
                            ...
                            tableString  = tableString + '<td><a href="https://plants.ensembl.org/Multi/Search/Results?species=all;idx=;q=' +record[0]+ '" target="_blank"> ' +record[0]+' </a></td>';
