...
<html>
    <head>
        ...
        <meta name="description" content="Functional domains of Puccinia proteins.">
        ...
        <!-- App title -->
        <title>Pathogen Domains - TRustDB</title>
...
<!-- End Navigation Bar-->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>This is a list of functional domains of <i>Puccinia</i> proteins, predicted using the InterProScan software package.</p>
                            </div>
        ...
        <script type="text/javascript">
            ...
            request.open("POST", "https://bioinfo.usu.edu/trustdb/queryPathogenDom.php",true);
