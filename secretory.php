...
<html>
    <head>
        ...
        <meta name="description" content="Puccinia species Secretory proteins.">
        ...
        <!-- App title -->
        <title>Secretory Proteins - TRustDB</title>
...
<!-- End Navigation Bar-->
        ...
        <div class="wrapper">
            <div class="container">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>
                                    This module contains the proteins of <i>Pgt</i> Ug99 and <i>Pgt</i> 21-0 that serve as Secretory proteins.
                                </p>
                ...
                <div class="row">
                    <div class="col-xl-8">
                        <h4 class="page-title"><i>Puccinia</i> species Secretory Proteins <i class="zmdi zmdi-info-outline" style="font-size: 25px" data-toggle="modal" data-target="#modal"></i></h4>
                    </div>
                </div>
                        ...
                        <table id="tableEffectors" class="table"  cellspacing="0" width="100%" style="font-size: 14px">
                            <thead class='thead-dark'>
                                <tr role="row">
                                    ...
                                    <th style="width: 140px;">Prediction Tool</th>
                                </tr>
                            </thead>
                            <tbody id="bodyTable">
        ...
        <script type="text/javascript">
            ...
            request.open("POST", "https://bioinfo.usu.edu/trustdb/querySecProtein.php",true);
                ...
                if (request.readyState === request.DONE) {
                    if (request.status === 200) {
                        ...
                        for(i = 0; i< lines.length-1; i++){
                            ...
                            tableString  = tableString + '<td><a href="https://services.healthtech.dtu.dk/service.php?SignalP-5.0"> SignalP </a>'+'</td>';
                            // tableString  = tableString + '<td>'+"SignalP"+'</td>';
                            tableString  = tableString + '</tr>';
                        }
