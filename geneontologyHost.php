...
<html>
    <head>
        ...
        <meta name="description" content="Gene Ontology for Triticum aestivum proteins">
        ...
        <!-- App title -->
        <title>Gene Ontology - TRustDB</title>
...
<!-- End Navigation Bar-->
        ...
        <div class="wrapper">
            <div class="container">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>This is a list of <i>Triticum aestivum</i> proteins GO annotations obtained using the InterProScan software. For some of the accesions, no GO annotation was retrieved, still, we provide those records in order to let the users decide which information they want to use.</p>
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <h4 class="page-title"> Gene Ontology (GO) Term Annotations <i class="zmdi zmdi-info-outline" style="font-size: 25px" data-toggle="modal" data-target="#modal"></i></h4>
                    </div>
                </div>
                    ...
                    <div class="card-box">
                        <div class="row">
                            <div class="col-md-5" id="speciesSelect" >
                                ...
                                <optgroup label="Triticum species [Susceptible to common bunt]" style="font-style: italic;">
                        ...
                        <table id="tableGO" class="table"  cellspacing="0" width="100%" style="font-size: 14px">
                            <thead class='thead-dark'>
                                <tr role="row">
                                    <th>Accession</th>
                                    <th>GO terms</th>
                                    <th>InterPro Accessions</th>
                                    <th>InterPro Descriptions</th>
                                </tr>
                            </thead>
                            <tbody id="bodyTable">
        ...
        <script type="text/javascript">
            ...
            request.open("POST", "https://bioinfo.usu.edu/trustdb/queryTriticumGO.php",true);
                ...
                if (request.readyState === request.DONE) {
                    if (request.status === 200) {
                        ...
                        for(i = 0; i< lines.length-1; i++){
                            ...
                            tableString  = tableString + '<td><a href="https://www.ebi.ac.uk/interpro/entry/InterPro/' + record[2] + '"target="_blank">' + record[2] +'</a></td>';
                            tableString  = tableString + '<td>'+record[3]+'</td>';
                            tableString  = tableString + '</tr>';
                        }

                        $('#tableGO').DataTable().clear();
                        $('#tableGO').DataTable().destroy();

                        document.getElementById('bodyTable').innerHTML = tableString;

                        $('#tableGO').DataTable({"pageLength": 25});
