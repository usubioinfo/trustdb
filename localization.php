...
<html>
    <head>
        ...
        <meta name="description" content="Subcellular localizations of Puccinia species proteins.">
        ...
        <!-- App title -->
        <title>Subcellular Localization - TRustDB</title>
...
<!-- End Navigation Bar-->
        ...
        <div class="wrapper">
            <div class="container">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>This module comprises of protein subcellular localization annotations of the <i>Puccinia</i> proteins.</p>
                                <hr>
                                <p> <i>Puccinia</i> species proteins were analyzed using a standalone tool, <a target="_blank" href="http://www.cbs.dtu.dk/services/DeepLoc/">DeepLoc-1.0</a>, to predict the subcellular localization.</p>
                                <hr>
                                <p>Score value is from DeepLoc tool, which assigns a location to the proteins, whereby a prediction confidence increase proportionally with the score value.</p>
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <h4 class="page-title"> Subcellular Localization <i class="zmdi zmdi-info-outline" style="font-size: 25px" data-toggle="modal" data-target="#modal"></i></h4>
                    </div>
                </div>
                    ...
                    <div class="card-box">
                        <div class="row">
                            <div class="col-md-5" id="speciesSelect" >
                                <select class="form-control select2" id="puccinia" style="font-style: italic;">
                        ...
                        <table id="tableEffectors" class="table table-striped table-bordered"  cellspacing="0" width="100%"class="table"  cellspacing="0" width="100%" style="font-size: 14px">
        ...
        <script type="text/javascript">
            ...
            request.open("POST", "https://bioinfo.usu.edu/trustdb/queryPathogenLoc.php",true);
